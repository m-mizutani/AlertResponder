...
PARAMETERS := $(shell cat $(AR_CONFIG) | grep -e LambdaRoleArn -e StepFunctionRoleArn -e NotifyStreamArn -e NotifyTopicArn -e PolicyLambdaArn -e InspectionDelay -e ReviewDelay | tr '\n' ' ')
